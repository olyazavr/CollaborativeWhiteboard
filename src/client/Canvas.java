...
public class Canvas extends JPanel {
	...
	public Canvas(String boardName, String IP, Color bgColor, String userName,
			boolean newWhiteboard) throws UnknownHostException, IOException {
		...
		BoxLayout pButtonLayout = new BoxLayout(paintButtonContainer,
				BoxLayout.Y_AXIS);
		BoxLayout eButtonLayout = new BoxLayout(eraserButtonContainer,
				BoxLayout.Y_AXIS);
		...
		paintButtonContainer.setBorder(BorderFactory.createEmptyBorder(25, 0,
				12, 0));
		eraserButtonContainer.setBorder(BorderFactory.createEmptyBorder(13, 0,
				25, 0));
	...
	private void setupWhiteboard() {
		try {
			if (newWhiteboard) {
				...
				outQueue.put("NEW " + name + " " + bgColor.getRed() + " "
